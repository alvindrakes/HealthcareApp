 ...
 * detector class which will accept updates
 * from accelerometer sensor and
 * deploys the filter to detect if a
 *step has been covered by the user. Create a class called
 * StepDetector.java add the below
 * code in it.
 * Created by OMS on 2/21/2018.
 */
