...
public class ProfilePage extends AppCompatActivity
  ...
  protected void onCreate (Bundle savedInstanceState) {
    ...
    //Initialize spacesuit variables
        ...
        .addValueEventListener(new ValueEventListener() {
          ...
          public void onDataChange (DataSnapshot dataSnapshot) {
            ...
            if (user.getSleepToday() != 0) {
              ...
              sleepInfo.setText(String.valueOf(hour) + "hours " + String.valueOf(minute) +
                                    "minutes");
    ...
    FirebaseDatabase.getInstance()
        ...
        .addValueEventListener(new ValueEventListener() {
          ...
          public void onDataChange (DataSnapshot dataSnapshot) {
            ...
            if (transaction.isSpacesuit1()) spacesuit1.setVisibility(View.VISIBLE);
            if (transaction.isSpacesuit2()) spacesuit2.setVisibility(View.VISIBLE);
            if (transaction.isSpacesuit3()) spacesuit3.setVisibility(View.VISIBLE);
            if (transaction.isSpacesuit4()) spacesuit4.setVisibility(View.VISIBLE);
          }
    ...
    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
      ...
      public void onClick (DialogInterface dialog, int id) {
        if (user.getCoin() >= 100) {
          ...
          if (indicatorSpacesuit == 1) transaction.setSpacesuit1(true);
          if (indicatorSpacesuit == 2) transaction.setSpacesuit2(true);
          if (indicatorSpacesuit == 3) transaction.setSpacesuit3(true);
          if (indicatorSpacesuit == 4) transaction.setSpacesuit4(true);
  ...
  //Update visibility of user info/edits
